 ...
 * 
 */
package perscholas.shameena.delimitedfile;
...
public class MyRunner {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String location = "/Users/homeoffice/Shameena/PerScholas/Java Tutorials/GLab-ReadingFromDelimitedFile/src/perscholas/shameena/delimitedfile/CourseData.csv";
