package org.shameenakoodan.PasswordTestVerify.junit.test;
...
import org.shameenakoodan.PaswwordTestVerify.junit.test.PasswordComply;
...
public class PasswordComplyUsingHooksTest {
	...
	private static void prepareLoadTestData() {
		try {
			...
			myFileReader = new File("/Users/homeoffice/Shameena/PerScholas/JUNIT/PasswordFile.txt");
