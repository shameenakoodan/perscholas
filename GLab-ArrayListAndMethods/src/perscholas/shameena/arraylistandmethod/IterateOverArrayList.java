package perscholas.shameena.arraylistandmethod;
...
public class IterateOverArrayList {
	public static void main(String[] args) {
		...
		/*
		 * //How do we use the iterator to start at a specific value - like "Friends"?
		 */
	...
	*/
		System.out.println("To start at the second element");
		iterator.next();
