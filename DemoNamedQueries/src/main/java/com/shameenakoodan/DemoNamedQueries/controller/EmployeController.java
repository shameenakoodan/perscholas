package com.shameenakoodan.DemoNamedQueries.controller;
...
import com.shameenakoodan.DemoNamedQueries.model.Employee;
...
//------------  Hibernate Named Query   ------------- 
	...
	public void ShowOfficeCodes_AsDepartment() {
		...
		Session session = factory.openSession();
		// ------------ Hibernate Named Query -------------
		TypedQuery query = (TypedQuery) session.getNamedQuery("empDepAlias");
